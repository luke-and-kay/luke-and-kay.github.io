    ...
    const items = guests.map((guest, index) => {
        ...
        return `
            <li class="challenge-list-item">
                <a class="challenge-person-link" href="challenge/${index + 1}.html">
    ...
    if (!guest) {
        app.innerHTML = `
            <div class="challenge-card">
                ...
                <a class="challenge-action" href="../challenge.html">Back to challenge</a>
            </div>
        `;
        return;
    }
...
function getHomeHref() {
    return window.location.pathname.includes('/challenge/') ? '../index.html' : 'index.html';
}

function getListHref() {
    return window.location.pathname.includes('/challenge/') ? '../challenge.html' : 'challenge.html';
}
